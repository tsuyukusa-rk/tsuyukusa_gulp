...
// Added by MicroEngine MailForm.
require_once('../define.php');
if (!defined('DATA_ROOT')) {
    define('DATA_ROOT', dirname(dirname(dirname(__FILE__))) . '/data');
}

// parsing config file.
$config_ini = parse_ini_file(DATA_ROOT . '/config/config.ini', true);
foreach($config_ini['captcha'] as $var_name => $value) {
